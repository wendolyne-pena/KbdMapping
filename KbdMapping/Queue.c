...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, KbdMappingQueueInitialize)
#endif

NTSTATUS
KbdMappingQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = KbdMappingEvtIoDeviceControl;
    queueConfig.EvtIoStop = KbdMappingEvtIoStop;
